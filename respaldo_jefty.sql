...
INSERT INTO `clientefrecuente` VALUES (4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1),(4,1);
...
INSERT INTO `detalleventaplatillo` VALUES (1,1,1,1),(2,1,2,1),(3,4,1,1),(4,5,2,2),(5,5,3,2),(6,6,5,100),(7,6,1,1),(8,6,2,1),(9,7,3,1),(10,8,4,1),(11,9,3,1),(12,10,2,1),(13,11,1,1),(14,11,2,1),(15,11,3,1),(16,11,4,1),(17,11,5,1),(18,15,3,1),(19,15,5,1);
...
CREATE TABLE `detpedido` (
  ...
  PRIMARY KEY (`id_detPedido`),
  KEY `lista_platillos` (`lista_platillos`),
  CONSTRAINT `detpedido_ibfk_1` FOREIGN KEY (`lista_platillos`) REFERENCES `platillo` (`id_platillo`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `detpedido` VALUES (1,5,1,3),(2,5,1,5);
...
INSERT INTO `encuesta` VALUES (1,'Encuesta de Cliente','¿Encontro lo que buscaba?','si','¿Alguna sugerencia de platillos?','ninguna','¿Recomendaria el sitio web?','si','¿Como le parecio el servicio?','le falta color','¿Que opina del lugar?','esta muy bien');
...
INSERT INTO `pagos` VALUES (1,716.30,'credito',3123556),(2,250.00,'null',3123556),(3,250.00,'credito',3123556),(4,11493.86,'credito',3123556),(5,259.79,'credito',3123556),(6,308.28,'credito',3123556),(7,259.79,'credito',3123556),(8,298.36,'credito',3123556),(9,952.13,'credito',3123556),(10,633.65,'credito',3123556),(11,368.07,'credito',3123556),(12,368.07,'credito',3123556),(13,369.99,'credito',3123556);
...
INSERT INTO `pedido` VALUES (4,'2018-07-31','13:00','Calle la condeza ',1,2),(5,'2018-07-31','01:00','Calle la condeza 120',1,2);
...
INSERT INTO `puntoscliente` VALUES (4,36);
...
CREATE TABLE `tarjetacredito` (
  ...
  KEY `id_cliente` (`id_cliente`)
) ENGINE=MyISAM AUTO_INCREMENT=3123557 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tarjetacredito` VALUES (3123556,1,2021,'Credito','Fernando',1,-3257.63);
...
INSERT INTO `ventaplatillos` VALUES (1,4,2,473.86,'2018-07-10','credito',249.4),(2,4,0,0,'2018-07-10','credito',0),(3,4,0,0,'2018-07-10','credito',0),(4,4,1,275.5,'2018-07-10','credito',145),(5,4,2,716.3,'2018-07-21','credito',0),(6,4,3,11493.9,'2018-07-26','credito',0),(7,4,1,259.79,'2018-07-26','credito',0),(8,4,1,308.278,'2018-07-26','credito',0),(9,4,1,259.79,'2018-07-29','credito',0),(10,4,1,298.36,'2018-07-30','credito',0),(11,4,5,952.128,'2018-07-30','credito',0),(12,4,3,633.65,'2018-07-30','credito',0),(13,4,2,368.068,'2018-07-30','credito',0),(14,4,2,368.068,'2018-07-30','credito',0),(15,4,2,369.99,'2018-07-30','credito',0);
...
-- Dump completed on 2018-07-30  1:50:36
