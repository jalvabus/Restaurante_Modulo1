...
public class DAO_Pedido {
    ...
    public boolean sendEmail(String correo, String mensaje) {
        ...
        try {
            ...
            prop.put("mail.smtp.user", "juanalva432@gmail.com");
            prop.put("mail.smtp.password", "apocalypse00");
            ...
            message.setFrom(new InternetAddress("juanalva432@gmail.com"));
            ...
            String attachFile = "C:/reportes/detallePedido.pdf";
            ...
            transport.connect(host, "juanalva432@gmail.com", "apocalypse00");
    ...
    public void reporteCompra(int idVenta, String destinatario, String mensaje, String direccionEnvio, String contact, float total) {
        try {
            ...
            documento.add(new Paragraph("\t \t \n Gracias por comprar con nostros, aqui tienes el detalle de tu PEDIDO \n \n", FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK)));
            ...
            documento.add(new Paragraph("\t \t Total: $ " + String.valueOf(subtotal), FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK)));
