        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <h3 style="padding-left: 25px;"> Datos del pedido</h3>
                            <div class="col-sm-6 form-group" style="margin-top: 20px;">
                                <label>Fecha: </label>
                                <input type="date" class="form-control" id="fecha" placeholder="Numero de tarjeta">
                            </div>
                            <div class="col-sm-6 form-group" style="margin-top: 20px;">
                                <label>Hora: </label>
                                <input type="time" class="form-control" id="hora" placeholder="Numero de tarjeta">
                            </div>
